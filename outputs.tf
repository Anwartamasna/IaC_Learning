...
output "instances" {
  ...
  value = {
    ec2_instance = {
      ...
      harbor_url  = "http://${aws_instance.ec2_instance.public_ip}:30002"
    }
    second_ec2 = {
      ...
      harbor_url  = "http://${aws_instance.second_ec2.public_ip}:30002"
    }
    third_ec2 = {
      ...
      harbor_url  = "http://${aws_instance.third_ec2.public_ip}:30002"
    }
    CI_CD_server_ec2 = {
